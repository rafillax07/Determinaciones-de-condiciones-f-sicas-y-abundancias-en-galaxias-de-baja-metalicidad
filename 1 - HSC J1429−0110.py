# -*- coding: utf-8 -*-
"""
Created on Tue Oct 10 00:03:47 2023

@author: PC
"""

# Galaxia-1 HSCJ1429−0110
import pyneb as pn
import numpy as np
...
if i4363 !=0.0:
  if i5007 !=0.0 and i4959 !=0.0:
   temO3 = O3.getTemDen(i4363/(i5007+i4959), den=den, to_eval = 'L(4363)/(L(4959)+L(5007))') 
  if i5007 !=0.0 and i4959 ==0.0:
...
abFe = abFe3 * (0.301*v - 0.259 + 1.367/v)
...
if abN2 ==0.0:
 labN2 = 0.0
abN = abN2 * (-0.809*v + 0.712 + 0.852/v)
if abN !=0.0:
...
abNe = abNe3 * (-0.405*w + 1.382 + 0.021/w)
...
if abAr4 ==0.0:
 labAr4 = 0
abAr = abAr3 * (0.285*v + 0.833 + 0.051/v)
if abAr !=0.0:
